...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
     ...
     * @throws
     */
    public void init(Context context, IssueApplication app) {
        // 传入app对象，为完美终止app  
        this.app = app;
        mContext = context;
...
//            activitys.offline();
            ...
            HomeShowNewActivity homeShowNewActivity=HomeShowNewActivity.getInstance();
