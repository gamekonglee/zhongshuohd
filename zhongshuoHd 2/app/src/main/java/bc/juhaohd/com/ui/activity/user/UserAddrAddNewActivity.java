...
import bc.juhaohd.com.controller.user.UserAddrAddController;
 ...
 * @desc ${TODD}
 */
public class UserAddrAddNewActivity extends BaseActivity {
    ...
    protected void initView() {
        setContentView(R.layout.activity_user_address_add_new);
        //沉浸式状态栏
