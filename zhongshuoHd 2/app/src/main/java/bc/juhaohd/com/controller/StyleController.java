...
public class StyleController extends  BaseController implements INetworkCallBack {

    private final StyleFragment mView;

    public StyleController(StyleFragment spaceFragment) {
