...
public class BottomBar extends LinearLayout implements View.OnClickListener {
    ...
    protected void onFinishInflate() {
        ...
        frag_diy_tv = (TextView) findViewById(R.id.frag_diy_tv);
        ...
        frag_home_iv = (ImageView) findViewById(R.id.frag_home_iv);
        frag_product_iv = (ImageView) findViewById(R.id.frag_product_iv);
        frag_diy_iv = (ImageView) findViewById(R.id.frag_diy_iv);
        ...
        findViewById(R.id.frag_diy_ll).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.frag_diy_ll:
                frag_diy_tv.setSelected(true);
                frag_diy_iv.setSelected(true);
                break;
    ...
    private void defaultTabStyle() {
        ...
        frag_home_iv.setSelected(false);
        frag_product_tv.setSelected(false);
        frag_product_iv.setSelected(false);
        frag_diy_tv.setSelected(false);
        frag_diy_iv.setSelected(false);
