...
public class CreateTools {
    ...
    public static void gen() {
        ...
        File file = new File("./app/src/main/res/values-w1400dp/dimens.xml");
...
//                    sw480.append(start).append(num * 1.5).append(end).append("\r\n");
                    ...
                    w600.append(start).append(num * 0.4).append(end).append("\r\n");
...
//            String sw480file = "./app/src/main/res/values-sw480dp-land/dimens.xml";
            ...
            String w600file = "./app/src/main/res/values/dimens.xml";
