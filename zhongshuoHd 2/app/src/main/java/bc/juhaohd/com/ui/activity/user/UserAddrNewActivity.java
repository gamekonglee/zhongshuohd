...
import bc.juhaohd.com.controller.user.UserAddrController;
 ...
 * @desc ${TODD}收货地址
 */
public class UserAddrNewActivity extends BaseActivity {
    ...
    protected void initView() {
        setContentView(R.layout.activity_user_address_new);
        //沉浸式状态栏
    ...
    protected void onViewClick(View v) {
        switch (v.getId()){
            case R.id.btn_save:
                IntentUtil.startActivity(this,UserAddrAddNewActivity.class,false);
            break;
        }
    }
