...
public class Constance {
    ...
    public static final String CAMERA_PATH = "aokete/camera";//拍照保存在sd卡下的文件夹名称
    ...
    public static final String MESSAGE_RECEIVED_ACTION = "bc.aokete.com.MESSAGE_RECEIVED_ACTION";
    ...
    public static String sharePath="share_url";

    public static String shareRemark="shareRemark";

    public static String barheight="barheight";

    public static String data="data";

    public static String two_code="two_code";
    ...
    public static String attr_stock="attr_stock";
