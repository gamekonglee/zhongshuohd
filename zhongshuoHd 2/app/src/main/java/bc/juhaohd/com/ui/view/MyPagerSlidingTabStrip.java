...
public class MyPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = 0x00ffffff;
    ...
    private int tabBackgroundResId = R.drawable.background_tab_new;
    //	-----------------add
...
//	gaga:pstsSelectTextViewColor="#ff4d00"
    ...
    private int selectColor=0xffffff;
...
//	-----------------end
    ...
    public MyPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColor = a.getColor(R.styleable.test_test1, tabTextColor);
        ...
        expandedTabLayoutParams.leftMargin= UIUtils.dip2PX(30);
        defaultTabLayoutParams.leftMargin=UIUtils.dip2PX(30);
        if (locale == null) {
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                tab.setBackground(getResources().getDrawable(R.drawable.bg_corner_white_500));
                //-------------end
                ...
                if(mcurrent==i){
                    ...
                    tab.setBackground(getResources().getDrawable(R.drawable.bg_corner_orange_full));
                    //-------------end
                }
            }
        }
