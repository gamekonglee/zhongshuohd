...
public class TypeController extends  BaseController implements INetworkCallBack {

    private final TypeFragment mView;

    public TypeController(TypeFragment spaceFragment) {
