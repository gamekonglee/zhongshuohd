 ...
 * @desc ${TODD}
 */
public class NumberInputTextView extends LinearLayout implements View.OnClickListener{
    ...
    public NumberInputTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onFinishInflate() {
        ...
        mIncreaseIv=(TextView) findViewById(R.id.rightTv);
        mDecreaseIv=(TextView) findViewById(R.id.leftTv);
        mIncreaseIv.setOnClickListener(this);
        mDecreaseIv.setOnClickListener(this);
        mNumberTv=(EditText) findViewById(R.id.et_num);
